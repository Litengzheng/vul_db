...
In  formTcpipSetup function,it reads in a user-provided parameter `curTime`.

<div  align="center"><img src="./img/goform.png" style="zoom:80%;" /></div>

And the variable `Var` is passed to the sprintf function without any length check, which may overflow the stack-based buffer `v45`. 
