...
And finally in sub_3A874 function ,the variable of a1 is passed to sprintf,which may overflow the stack-based buffer s. 

<div  align="center"><img src="./img/sub_3A874.png" style="zoom:80%;" /></div>
