# Belkin F9K1122 Vulnerability（CVE-2026-5044）
...
In  formSetSystemSettings function,it reads in a user-provided parameter `webpage`.
...
```
POST  /goform/formSetSystemSettings HTTP/1.1
Host: 192.168.206.1
