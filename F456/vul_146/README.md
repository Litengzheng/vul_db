...
If the value of wanmode is 2, the variable `v16` is passed to the sub_3B860 function without any length check, which may overflow the stack-based buffer `s`. 
